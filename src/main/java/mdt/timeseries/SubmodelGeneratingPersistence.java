 ...
 */
public class SubmodelGeneratingPersistence implements Persistence<PersistenceInMemoryConfig> {
	private final Persistence<PersistenceInMemoryConfig> m_basePersistence;
	
	public SubmodelGeneratingPersistence(Persistence<PersistenceInMemoryConfig> basePersistence) {
		m_basePersistence = basePersistence;
	}

	@Override
	public void init(CoreConfig coreConfig, PersistenceInMemoryConfig config, ServiceContext serviceContext)
